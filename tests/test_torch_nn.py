...
def test_torch_nn_functional_oneliner():
  ...
  t2j_function_test(torch.nn.functional.tanh, [(6, 6)], atol=1e-6)
  t2j_function_test(torch.nn.functional.tanhshrink, [(6, 6)], atol=1e-6)
  t2j_function_test(torch.nn.functional.threshold, [(6, 6)], kwargs=dict(threshold=0.0, value=1.0), atol=1e-6)
